...
ActiveRecord::Schema[7.2].define(version: 2024_09_20_122551) do
  ...
  create_table "motorbike_types", force: :cascade do |t|
    t.string "name"
    t.string "category"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "motorcycles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "motorbike_type_id", null: false
    t.index ["motorbike_type_id"], name: "index_motorcycles_on_motorbike_type_id"
  ...
  add_foreign_key "motorcycles", "motorbike_types"
